            ...
            <div className='footer'>
                <div className='flex flex-col gap-4 max-[480px]:items-center'>
                    <div className='flex items-center gap-2'>
                        <div className='h-12 w-12 bg-zinc-400 flex justify-center items-center font-bold text-base text-white'>LOGO</div>
                        <div className='text-2xl font-semibold text-white'>NIGHTLANCER</div>
                    </div>
                    <div className='flex gap-4'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 24 24" fill="#B7B4BB" className='transition-all duration-300 ease-in-out hover:fill-[#fff]'>
                ...
                <div className='flex flex-col justify-end gap-4'>
                    {/* <div className='up_border'>
                        <div className='bg-black flex justify-center items-center rounded-full h-10 w-10 m-[1.5px]'>
